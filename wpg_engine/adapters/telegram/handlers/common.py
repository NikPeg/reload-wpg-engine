...
async def start_command(message: Message) -> None:
    ...
    if is_admin_user:
        ...
        await message.answer(
            ...
            "Чтобы посмотреть примеры сообщений, используйте /examples\n\n"
            "<b>Что такое ВПИ?</b>\n"
...
async def help_command(message: Message) -> None:
    ...
    if not player:
        await message.answer(
            ...
            "/examples - посмотреть примеры сообщений\n"
