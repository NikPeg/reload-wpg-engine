    ...
    if is_admin_user:
        ...
        if player and player.role == PlayerRole.ADMIN and player.game:
            ...
            await message.answer(
                ...
                f"• /active - активность стран (сообщения за неделю)\n"
...
async def help_command(message: Message) -> None:
    ...
    if not player:
        ...
        await message.answer(
            ...
            "/active - активность стран (сообщения за неделю)\n"
            ...
            "<i>💡 Команды /stats и /send доступны только игрокам.</i>",
            parse_mode="HTML",
        )
    else:
        await message.answer(
